...
export function DashboardSearchInput({
  ...
  return (
    <label className="panel-muted flex min-w-0 items-center gap-3 rounded-[20px] border border-border-subtle/60 px-3.5 py-2.5 text-text-secondary shadow-[inset_0_1px_0_rgba(255,255,255,0.16)] transition duration-300 focus-within:border-primary/30 focus-within:shadow-(--shadow-glow) sm:min-w-76">
